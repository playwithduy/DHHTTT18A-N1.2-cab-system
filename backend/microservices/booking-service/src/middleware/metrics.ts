...
client.collectDefaultMetrics({ prefix: 'cabgo_booking_' });

export const httpLatencyHistogram = new client.Histogram({
  name: 'cabgo_booking_request_duration_seconds',
...
export const metricsMiddleware = (req: Request, res: Response, next: NextFunction) => {
  ...
  // Also log the incoming trace ID natively for structured format (112, 115)
